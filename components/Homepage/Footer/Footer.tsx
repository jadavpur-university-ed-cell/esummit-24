	...
	return (
	  ...
	  <footer className="bg-gray-800" id="footer" aria-labelledby="footer-heading">
		  ...
		  <div className="xl:grid xl:grid-cols-3 xl:gap-8">
			...
			<div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
			  <div className="md:grid md:grid-cols-2 md:gap-8">
				<div>
				  <h3 className="text-sm font-semibold text-[#f77f00] tracking-wider uppercase">Explore</h3>
				  <ul role="list" className="mt-4 space-y-4">
					{navigation.Explore.map((item) => (
					  <li key={item.name}>
						<Link href={item.href} className="text-lg text-[#eae2b7] hover:text-[#fcbf49]">
						  {item.name}
						</Link>
					  </li>
					))}
				...
				<div className="mt-12 md:mt-0">
				  <h3 className="text-sm font-semibold text-[#f77f00] tracking-wider uppercase">Help</h3>
				  <ul role="list" className="mt-4 space-y-4">
					{navigation.Help.map((item) => (
					  <li key={item.name}>
						<Link href={item.href} className="text-lg text-[#eae2b7] hover:text-[#fcbf49]" download target="blank">
						  {item.name}
						</Link>
					  </li>
					))}
			  ...
			  <div className="md:grid md:grid-cols-2 md:gap-8">
				<div>
				  <h3 className="text-sm font-semibold text-[#f77f00] tracking-wider uppercase">Contact</h3>
				  <ul role="list" className="mt-4 space-y-4">
        ...
        <div className="mt-1 md:mt-0 md:order-1">
          <p className="text-center text-xl text-[#eae2b7]">&copy; 2024 <Link href='www.juecell.com'>Jadavpur University Entrepreneurship Cell</Link>. All rights reserved.</p>
        </div>
      </div>
		</div>
	  </footer>
