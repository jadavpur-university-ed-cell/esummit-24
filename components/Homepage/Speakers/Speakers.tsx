...
const SpeakerItems: React.FC<SpeakerDetails> = ({
  image,
  name,
  designation,
  about,
  ...
  <div className="p-4 sm:w-4/5 lg:w-11/12">
    <div className="h-full bg-gray-700 bg-opacity-40 px-8 py-8 rounded-xl overflow-hidden text-center relative transform transition-transform duration-300 hover:scale-105 hover:bg-gray-700">
      ...
      <div className="flex items-center justify-between my-4">
        <h1 className="title-font sm:text-4xl text-2xl font-bold text-gray-100">
          {name}
        </h1>
        <h2 className="tracking-widest text-xl title-font font-extralight text-[#f77f00] w-1/3 text-wrap">
          {designation}
        </h2>
      </div>
  ...
  return (
    <>
      <div className=" flex justify-center p-8 items-center">
        <h1 className="animated-title text-5xl md:text-7xl text-[#fcbf49] font-bold">
          Speakers
        </h1>
      </div>
