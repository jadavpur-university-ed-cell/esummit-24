...
const About: FunctionComponent = () => {
	return (
		<section
			id="about"
			className=" bg-[#040411] w-full min-h-screen flex flex-col  justify-center text-white z-10">
			<div className="flex flex-col items-center min-h-[80vh] sm:min-h-screen justify-around px-8 z-10 bg-[#040411]">
				...
				<div className="sm:grid flex flex-col sm:grid-cols-2 justify-center items-center justify-items-center my-auto px-6 ">
					<Image
						className="w-[70vw] sm:w-[480px] md:h-[65vh] md:w-[45vw] object-cover rounded-2xl"
						src="/about-bg.png"
						alt="logo"
						width={528}
						height={272}
					/>
					<div className="flex flex-col md:w-[40vw] h-full items-center mb-auto sm:text-3xl text-2xl text-center sm:text-start sm:p-4 p-8">
