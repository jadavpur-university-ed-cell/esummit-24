...
const UserDetails = ({ user }: { user: User }) => {
	return (
		<div className="w-full">
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center text-lg gap-y-2">
				<p>Name: {user.name}</p>
	...
	return (
		<div className="relative pb-20 pt-26 min-h-screen bg-[#101720] text-white">
			<div className="flex flex-col items-center">
				...
				<div>
					<button
						className="flex justify-center text-xl bg-white text-[#101720] font-medium px-2 py-1"
						onClick={toggleEditUser}>
						Edit Details
					</button>
					<dialog
						ref={editUserRef}
						className="relative h-[80vh] w-[70vw] backdrop:bg-[#00000080] bg-[#101720] text-white">
						<EditUser user={user} />
						<button
							onClick={toggleEditUser}
