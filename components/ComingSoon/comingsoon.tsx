  ...
  return (
    ...
    <div className="pb-20 pt-26 flex flex-col items-center">
      ...
      >
        ...
        <div
          // chnage the bg to bg-blue one, so it matches the bg color and will blend in
          className="absolute pointer-events-none inset-0 flex items-center justify-center bg-[#101720]
      ...
      <div className="flex justify-center relative my-5 z-10">
        ...
        <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
           ...
           */}
         <Image src="/svg_pers/E-Summit_Logo_Glow.png" alt='' height={600} width={350}/>
          <TextGenerate words="Coming Soon" className="text-center text-[60px] md:text-5xl lg:text-6xl" />
