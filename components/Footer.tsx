      ...
      <section id="footer" className="flex flex-col  justify-start w-screen items-center bg-inherit">
        ...
        <div className="flex sm:flex-row flex-col gap-1 sm:gap-0 sm:justify-between rounded-lg shadow mb-4 bg-gray-800 min-w-[95vw] p-1 max-w-[90vw] sm:max-w-[100vw]">
          ...
          <div className="w-full mx-auto max-w-screen-xl  flex items-center justify-center sm:justify-between">
            <span className="sm:text-sm text-xl text-center text-gray-400">© 2024
          ...
          <div className="text-gray-400 grid grid-cols-4 gap-3 mx-auto sm:mr-3">
            ...
            <Link href="https://www.linkedin.com/school/juecell" target="blank">
              <FaLinkedin className="footer-icons text-xs sm:text-lg transition-colors duration-150 ease-in-out hover:text-blue-700"/>
            </Link>

            <Link href="https://www.facebook.com/juecell" target="blank">
              <FaFacebook className="footer-icons text-xs sm:text-lg transition-colors duration-150 ease-in-out hover:text-blue-400" />
            </Link>

            <Link href="https://www.instagram.com/juecell/" target="blank">
              <FaInstagram className="footer-icons text-xs sm:text-lg absolute transition-colors duration-150 ease-in-out hover:text-rose-500"/>
            </Link>

            <Link href="https://twitter.com/ju_ecell" target="blank">
              <BsTwitterX className="footer-icons text-xs sm:text-lg  transition-colors duration-150 ease-in-out hover:text-white" />
            </Link>
          </div>
        </div>
    </section>
